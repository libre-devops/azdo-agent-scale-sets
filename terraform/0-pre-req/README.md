...
| [azurerm_key_vault_secret.azdo_pat](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/key_vault_secret) | data source |
| [azurerm_key_vault_secret.azdo_url](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/data-sources/key_vault_secret) | data source |
...
| <a name="input_azdo_pat"></a> [azdo\_pat](#input\_azdo\_pat) | The PAT token for Azure DevOps access | `string` | `"AzdoPat"` | no |
| <a name="input_azdo_url"></a> [azdo\_url](#input\_azdo\_url) | The URL of Azure DevOps instance | `string` | `"AzdoUrl"` | no |
